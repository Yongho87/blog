var store = [{
        ...
        "excerpt":"그린버드 로고 그린버드 1인 부트스트랩 스타트업을 운영하면서 무료 습관 관리 앱인 그린버드를 개발하여 제 블로그에 소개하려고 합니다. 그린버드 습관 관리 앱의 차별성 간단하고 깔끔하지만 습관 관리에 필요한 모든 기능들을 모두 포함하였습니다. 그린버드의 핵심기능들은 기본적으로 무료이며 플러스로 업그레이드 하지 않아도 습관을 만들고 싶은 사람들의 습관관리에 실질적인 도움이 될 수 있도록 만들기...","categories": [],
        "tags": [],

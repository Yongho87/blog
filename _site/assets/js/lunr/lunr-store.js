var store = [{
        ...
        "tags": [],
        "url": "/blog/2021/03/09/KG-1-%EA%B8%88%EC%9C%B5%EC%8B%9C%EC%9E%A5%EC%9D%98-%ED%98%84%EC%9E%AC-%ED%9D%90%EB%A6%84.html",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "/blog/2021/03/10/KG-2-%EC%82%AC%EC%97%85%EC%9D%84-%EA%B5%AC%EC%84%B1%ED%95%98%EB%8A%94-5%EA%B0%80%EC%A7%80-%EC%9A%94%EC%86%8C.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #3 - 인간의 기본적인 욕구",
        ...
        "tags": [],
        "url": "/blog/2021/03/11/KG-3-%EC%9D%B8%EA%B0%84%EC%9D%98-%EA%B8%B0%EB%B3%B8%EC%A0%81%EC%9D%B8-%EC%9A%95%EA%B5%AC.html",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "/blog/2021/03/12/KG-4-%EC%82%AC%ED%9A%8C%EC%A0%81-%EC%A7%80%EC%9C%84%EB%A5%BC-%EC%A0%9C%ED%92%88%EC%97%90-%EB%B0%98%EC%98%81%ED%95%98%EB%8A%94%EA%B2%83.html",
        "teaser": null
      },{
        "title": "컴퓨터 공학 및 프로그래밍 #1 - Data alignment, 포인터, Buffer Overflow",
        "excerpt":"Data alignment 프로세서가 메모리에서 값을 가져올 때 특정 배수단위로 주소를 기반으로 가져 오기 때문에 성능 최적화를 위해서는 메모리에 저장되는 각 타입(short, int, double)의 주소도 메모리상에 배수형태(2, 4, 8)로 저장되어야 함. 이를 위해 struct type과 같은 경우 내부에 혹은 마지막에 추가적인 바이트를 넣어서 struct 내부의 값 혹은 element를 struct로 갖는 array의...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/13/CS-1-%EC%BB%B4%ED%93%A8%ED%84%B0-%EA%B3%B5%ED%95%99-%EB%B0%8F-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D-%EC%A7%80%EC%8B%9D-1.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #5 - 권위에 순응하는 심리학, 경쟁의 숨겨진 이익, 용병의 법칙",
        "excerpt":"심리학 직업 타이틀(권위)에 순응하는 경향 사람들은 권위 및 사회적으로 지위가 높은 타이틀을 가지는 사람들의 말에 순응하는 경향이 존재한다. 자기보다 사회적 서열이 높거나 높은 자리에 있는 사람들(선생님, 교수, 의사, 검사, 정치인, 대통령, 고위공무원 등)이 하는 말을 스스로 생각해서 합리적인지 분석하지 않고 있는 그대로 따르는 현상이다. 대부분의 경우에는 이들의 이야기는 더 객관적이고...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/13/KG-5-%EA%B6%8C%EC%9C%84%EC%97%90-%EC%88%9C%EC%9D%91%ED%95%98%EB%8A%94-%EC%8B%AC%EB%A6%AC%ED%95%99-%EA%B2%BD%EC%9F%81%EC%9D%98-%EC%88%A8%EA%B2%A8%EC%A7%84-%EC%9D%B4%EC%9D%B5-%EC%9A%A9%EB%B3%91%EC%9D%98-%EB%B2%95%EC%B9%99.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #6 - 12가지의 비즈니스 형태",
        "excerpt":"Business &amp; Startup 12가지 일반적인 비즈니스 형태 우리들의 사업이 성공하기 위해서는 사람들에게 가치를 주어야 하고 이것은 사람들이 돈을 지불할 수 있도록 어떠한 형태를 갖고 있어야 한다. 다음은 12가지의 일반적인 가치의 형태와 이것들에 단순화된 개념이다. 제품: 유형의 물건 (물리적일 수도 디지털 형태일 수도 있음)을 만들어서 파는것. 만드는 비용보다 더 높은 가격에...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/14/KG-6-12%EA%B0%80%EC%A7%80-%EB%B9%84%EC%A6%88%EB%8B%88%EC%8A%A4-%ED%98%95%ED%83%9C.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #7 - 비트코인과 암호화폐",
        "excerpt":"참고: 레이달리오와 브릿지워터의 비트코인에 대한 관점 비트코인의 최근의 상승은 비트코인이 재산과 부의 저장공간으로 사용할 될 수 있을지에 대한 논의를 다시 불붙이고 있다 비트코인은 2020년에만 약 4배가 상승 현재 비트코인은 전체 암호화폐 시장중에 약 80%의 점유율을 가짐. 2017년 초반의 상승기때는 다른 코인들이(리플, 이더리움) 주도적으로 상승을 견인했으나 2020년부터 지금까지의 상승에서는 비트코인이 상승을...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/17/KG-7-%EB%B9%84%ED%8A%B8%EC%BD%94%EC%9D%B8%EA%B3%BC-%EC%95%94%ED%98%B8%ED%99%94%ED%8F%90-1.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #8 - 인플레이션과 금리 그리고 채권",
        "excerpt":"인플레이션과 금리와 채권에 대한 이해 채권에는 금리 위험이 존재 - 금리가 증가하면 채권가격은 떨어짐 (=채권 수익률은 증가).반대로 금리가 떨어지면 채권가격은 증가하고 채권수익률은 감소. 금리는 인플레이션에 반응 - 경제안에 있는 여러 가격들이 증가하면 중앙은행은 과열된 경제를 식히기 위해 기준금리를 상승시킴. 인플레이션은 채권의 액면가치를 갉아먹음. 만기가 긴 채권일 수록 이 효과는 더...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/19/KG-8-%EC%9D%B8%ED%94%8C%EB%A0%88%EC%9D%B4%EC%85%98%EA%B3%BC-%EA%B8%88%EB%A6%AC-%EA%B7%B8%EB%A6%AC%EA%B3%A0-%EC%B1%84%EA%B6%8C.html",
        "teaser": null
      },{
        "title": "성장을 위한 지식 #9 - 경제적 가치와 상대 중요도 테스트",
        "excerpt":"경제적 가치 고객이 우리에게 구매를 하는 매순간은 고객들은 그 시점에 그 돈으로 그들이 살 수 있는 다른 것보다 우리가 제공하는 것을 더 가치있다고 결정하는 것을 의미한다. 제품/서비스를 향상시키고 개발하면서 제일 중요한 것 중에 하나는 우리의 잠재고객들이 그들의 지갑에 있는 돈의 구매력보다 다른 어떤 것을 더 가치있게 생각하는지를 파악하는 일이다. 모든...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/23/KG-9-%EA%B2%BD%EC%A0%9C%EC%A0%81-%EA%B0%80%EC%B9%98%EC%99%80-%EC%83%81%EB%8C%80-%EC%A4%91%EC%9A%94%EB%8F%84-%ED%85%8C%EC%8A%A4%ED%8A%B8.html",
        "teaser": null
      },{
        ...
        "excerpt":"출처: Big Debt Crises by Ray Dalio를 번역+의역한 내용입니다. 전체 세계/국내 경제의 큰 흐름을 읽을 수 있는 눈을 키우기 위해 필요한 이해와 지식에 대한 설명. 크게 다음과 같은 순서로 설명 신용과 부채란 무엇인가 전형적인 큰 부채 사이클 디플레이션 부채 사이클을 구성하는 단계들 인플레이션적인 침체와 통화위기 인플레이션 부채 사이클을 구성하는 단계들...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/30/%EB%A0%88%EC%9D%B4%EB%8B%AC%EB%A6%AC%EC%98%A4-%EA%B2%BD%EC%A0%9C%EC%9D%98-%EA%B8%B0%EB%B3%B8-2.html",
        "teaser": null
      },{
        "title": "무료 습관 관리 앱 그린버드 - 습관관리 핵심 기능 모두 탑재한 깔끔하고 간단한 앱",
        "excerpt":"그린버드 로고 “측정할 수 없다면, 개선할 수 없다” - 피터 드러커 무료 습관 관리 앱 그린버드 추천 무료 습관 관리 앱 그린버드를 소개합니다. 그린버드는 매일매일 타임라인 형식으로 습관을 체크 할 수 있습니다. 그린버드 타임라인 그린버드는 습관을 쉽게 관리 할 수 있습니다. 그린버드 습관관리 그린버드는 습관의 복리효과를 기반으로 습관 점수(=의지력)를 계산하여...","categories": [],
        "tags": [],
        ...
        "excerpt":"슈독 - 나이키 그리고 필 나이트 나이키 창업자 필 나이트가 직접 작성한 본인의 자서전이자 나이키가 어떻게 성장했는지를 알려주는 책. 24세의 젊은 나이에 아무 것도 없이 오니즈카 타이거의 신발 10켤레를 가져다 미국에 파는 작은 유통업체로 시작하여 현재의 시가총액 200조의 세계적인 스포츠 용품 회사가 되기까지의 여정을 필 나이트의 기억과 관점으로 서술한 자서전....","categories": [],
        "tags": [],
        ...
        "title": "2022년 5월의 일기",
        "excerpt":"5월 1일 (일) 상대방의 성향과 모습을 최대한 생각해서 배려하고 행동해야 한다. 상황이 마음에 들지 않더라도 상대방이 나에게 나쁜마음을 품고 행동하는 것은 절대 아니다. 내가 말하는 내용이 남들에게 들리는 것이 신경쓰여 특정 장소에서 말이 없어지고 침묵하는 성향 오늘부터 한달동안 꾸준하게 할 것들을 정했다. 작은 것이지만 일관성있게 행동으로 옮기는 것이 어렵기 때문에...","categories": [],
        "tags": ["일기"],
        "url": "/blog/2022/05/02/5%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        ...
        "excerpt":"폴 그램이 포브스 표지 모델로 나왔을때 이미지 출처: https://miro.medium.com/max/920/1UMZok6t6Fq9uikYbnwLZkA.png 폴 그램 (paul graham) 소개 및 번역의 이유 원문 링크 폴그램의 에세이를 번역한 글입니다. 원문은 위에 있는 링크를 통해 볼 수 있습니다. 폴그램은 하버드대학교 컴퓨터 공학과 박사 출신입니다. 졸업이후 1990년대 중반에 같은 대학교 친구들 총 3명과 viaweb이라는 최초의 온라인 쇼핑몰 웹어플리케이션을...","categories": ["life"],
        "tags": [],
        ...
        "title": "2022년 6월의 일기",
        "excerpt":"6월 1일 (수) 석수역에서 가양역까지 안양천을 따라 형성된 서울둘레길 6코스 완주. 약 4시간 30분 소요. 5월에 달성하고 싶은 습관(비포 슬립 루틴)들에 얹어서 6월에 달성하고 싶은 목표 3가지(웨이킹업 루틴)를 추가적으로 만들었다. 5시 기상 (10시 취침) 아침운동 런닝 테슬라 오토파일럿 AI 기술 1시간 분석 후 블로그에 포스팅. 석수역 - 가양역 - 광화문...","categories": [],
        "tags": ["일기","2022년 6월"],
        "url": "/blog/2022/06/02/6%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        "title": "건강한 신체를 유지하기 위한 운동종류 및 방법과 단백질 섭취 지식 정리",
        "excerpt":"운동과 단백질 섭취 건강한 신체를 계속 유지하고 싶다면 운동과 식단관리는 필수적이다. 이 지식을 기반으로 나의 운동 루틴에 반영하고 제대로 된 효율적인 방향으로 시간을 사용할 수 있게 하는 것이 목적이다. 일일 권장 단백질 섭취량 단백질 일일 권장 섭취량(Recommended Daily Allownace, RDA)은 몸무게 1kg당 0.8g. 하지만 나이가 들어감에 따라 감소하는 근질량을 보완해주기...","categories": ["health"],
        "tags": [],
        "url": "/blog/health/2022/06/17/%EC%9A%B4%EB%8F%99%EA%B3%BC-%EB%8B%A8%EB%B0%B1%EC%A7%88.html",
        "teaser": null
      },{
        "title": "2022년 7월의 일기",
        "excerpt":"7월 1일 (금) 행복해지는 것과 우리가 가지지 않은 것을 갈망하는 것을 동시에 하는 것은 불가능 하다. 행복은 원하는 것을 모두 갖고 있는 모든게 충족된 상태이다. 행복에 배고픔이나 목마름이 있으면 안된다. 에픽테투스 벌써 올해 1년의 반이 정확하게 지났다. 지난 6개월 동안에 시간을 어떻게 보냈는지 한번 되돌아보고 앞으로의 행동을 교정해야 한다. 어떠한...","categories": [],
        "tags": ["일기","2022년 7월"],
        "url": "/blog/2022/07/02/7%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        "title": "공급망관리(Supply Chain Management, SCM) 프로세스",
        "excerpt":"공급망관리 프로세스 실제 팀별 현업들의 업무를 통해 파악하는 실제 공급망관리 프로세스에 대한 비유적인 설명. 회사의 구조 바나나 회사 바나나 회사 티셔츠 사업부 상무 티셔츠 사업부 해외영업팀 5개 - 미국, 중국, 유럽, 일본, 남미 티셔츠 사업부 마케팅팀 티셔츠 사업부 SCM팀 티셔츠 사업부 생산팀 티셔츠 사업부 물류팀 해외영업 미국팀 - 홍길동 사원...","categories": [],
        "tags": [],
        "url": "/blog/2022/07/16/%EA%B3%B5%EA%B8%89%EB%A7%9D%EA%B4%80%EB%A6%AC(Supply-Chain-Management)-%ED%94%84%EB%A1%9C%EC%84%B8%EC%8A%A4.html",
        "teaser": null
      },{
        "title": "2022년 8월의 일기",
        "excerpt":"8월 1일 (월) 8월달의 시작. 새롭게 합류한 프로젝트의 결과가 잘 될 수 있게 기여해야 한다. 여의도 - 아현식자재마트 8월 2일 (화) empirical rule: 전날에 당류를 많이 먹으면 아침에 몸이 피곤하다. 굉장히 오랜만에 누군가와 직접적으로 같이 하게 될 일에 대해서 대화를 하게 되었다. 오랜만에 느낀 같은 문제를 같이 해결해나간다는 느낌에서 오는...","categories": [],
        "tags": ["일기","2022년 8월"],
        "url": "/blog/2022/08/02/8%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        "title": "샘해리스가 말하는 명상",
        "excerpt":"샘해리스가 말하는 명상 There are many approaches to meditation. There are thousands upon thousands books on the topic now hundreads of meditation app to help you practice. So how is waking up different? Well, for someone say that everything that is in waking up is here because I think it...","categories": [],
        "tags": ["명상","2022년 8월"],
        "url": "/blog/2022/08/28/%EC%83%98%ED%95%B4%EB%A6%AC%EC%8A%A4-%EB%AA%85%EC%83%81%EC%9D%B4%EB%9E%80-%EB%AC%B4%EC%97%87%EC%9D%B8%EA%B0%80.html",
        "teaser": null
      },{
        "title": "2022년 9월의 일기",
        "excerpt":"9월 3일 (토) 눈깜짝할 사이에 8월 한달이 지나갔고. 어느정도 새로운 환경과 일에 적응이 되는 시점. 한달동안 제대로 되지 않았던 습관들을 검토하면서 다시 제대로 습관을 할 수 있도록 다짐한 날. 기본적으로 모든 인간을 커다란 자기 멋대로 움직이는 코끼리, 그 코끼리 위에 코끼리를 조정하려고 노력하는 이성을 가진 존재 2가지로 이루어진다는 사실을 기억해야...","categories": [],
        "tags": ["일기","2022년 8월"],
        "url": "/blog/2022/09/02/9%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        "title": "2023년 첫 일기",
        "excerpt":"2023년과 글쓰기 작년에 호기롭게 다짐했던 글쓰기 습관 만들기 노력이 약 1년의 시간동안 멈춰 있었는데, 어제 우연히 친한 사람과의 대화에서 다시 한번 글쓰기의 중요성을 느끼게 되었다. 내 느낌과 생각을 글로 정리하는 것은 명확한 사고를 하고 자기관찰을 할 수 있다는 점에서 상당히 중요하다고 항상 생각하고는 있지만, 머리로 생각하는 것과는 별개로 행동으로 옮겨...","categories": [],
        "tags": ["일기","2023년 12월"],
        "url": "/blog/2023/12/16/2023%EB%85%84.html",
        "teaser": null
      },{
        "title": "불안함과 욕구",
        "excerpt":"불안함 오늘 회사에서 나의 미래의 고용계약과 관련된 사항에 대한 불안감을 느꼈다. 나의 존재가 투자할 만한 가치가 있는지를 새로운 팀장님에게 보고해야 하는 상황이 생긴 것이다. 나와 같이 일하는 분이 나에게 이와 관련된 내용을 정리해 보라고 해서 정리를 하고 얘기를 나눴다. 이 내용을 통해 계약이 되고 안되고를 결정 된다기 보다는, 계약은 하지만...","categories": [],
        "tags": ["에세이","2023년 12월"],
        "url": "/blog/2023/12/19/%EC%9A%95%EA%B5%AC.html",
        "teaser": null
      },{
        "title": "2023년 연말 동유럽 여행",
        "excerpt":"여행 개요 3커플(2부부, 1커플)이 같이간 동유럽 여행. 단 둘이서 갔을때 보다 기억에 더 많이 남을 것 같다. 일정 총 일정은 프라하 4박, 빈 2박, 잘츠부르크 2박, 빈 1박. 프라하 일정 1일차 - 로컬 크리스마스 마켓 구경. 성 바츨로프 동상 근처. 저녁 콜레뇨 등 동유럽 음식. 2일차 - 코젤 맥주 투어....","categories": [],
        "tags": ["여행","2023년 12월"],
        "url": "/blog/2024/01/02/23%EB%85%84-%EC%97%B0%EB%A7%90-%EC%97%AC%ED%96%89.html",
        "teaser": null
      },{
        "title": "2024년 1월2일과 1월4일",
        "excerpt":"1월 2일 (화) 나는 당신이 불행하다고 판단한다 왜냐하면 당신은 불행을 한번도 겪어보지 못했기 때문이다. 당신은 인생을 살면서 한명의 적도 만난적이 없다. 그렇기 때문에 아무도 당신이 얼만큼의 역량을 갖고 있는지 모른다. 심지어 당신조차도. 세네카 독서/오디오블/팟캐스트 정리 예전에 읽고 들었던 레이 달리오의 원칙을 다시 audiable로 듣는 중에 인상 깊은 내용들 몇 개만...","categories": [],
        "tags": ["일기","2024년 1월"],
        "url": "/blog/2024/01/02/1%EC%9B%94%EC%9D%98-%EC%9D%BC%EA%B8%B0.html",
        "teaser": null
      },{
        "title": "2024년 1월7일 (일)",
        "excerpt":"1월 7일 (일) 기억하라, 만약 당신이 그 본질이 노예적인 것을 자유라고 생각하고, 당신 것이 아닌것을 당신 것이라고 생각하면, 당신은 족쇄가 채워지고 비참해질 것이다. 신과 타인을 모두 비난할 것이다. 하지만, 당신이 당신이 가진것만을 당신것이라고 생각하고, 다른 사람이 소유하고 있는 것을 진정 당신것이 아니라고 생각한다면, 아무도 당신을 강제하거나 멈출 수 없을 것이다....","categories": [],
        "tags": ["일기","2024년 1월7일 (일)"],
        "url": "/blog/2024/01/07/diary.html",
        "teaser": null
      },{
        "title": "하워드 막스와 쇼펜하우어 행복론, 1월 13일 (토) 일기",
        "excerpt":"1월 13일 (토) 독서/오디오블/팟캐스트 정리 하워드 막스 구글 강연 (유튜브) 불확실성이란 3가지 사건들 중 하나의 사건이 벌어질 수 있다고 생각했는데 전혀 생각하지 못했던 다른 사건이 발생하는 것. 세상과 인생은 많은 분야에서 불확실성이 존재하다. 미래를 생각할때 기대 값과 각 사건의 발생확률을 고려하는게 아니라 발생할 수 있는 사건의 “범위”를 생각해야 한다. 투자로...","categories": [],
        "tags": ["일기","2024년 1월 13일 (토)"],
        "url": "/blog/2024/01/14/diary.html",
        "teaser": null
      },{
        "title": "열역학 상태방정식과 기액평형 (Equation of State, EOS, and Vapor Liquid Equilibrium, VLE)",
        "excerpt":"열역학 상태방정식으로 기액평형을 계산하는 구체적인 방법 개요 석유화학분야에서 사용하는 다양한 화학공정들 중에는 물질을 분리하는 공정들이 많다. 이 중에서 증류탑이라는 공정은 물질들이 같은 조건(=온도와 압력)에서 얼만큼 기체가 잘 되는지(=물질의 끓는점 차이, 상대 휘발도)의 특성에 따라서 물질을 분리하는 공정이다. 예를 들어, 물과 에탄올이 50%씩 섞여있는 액체 혼합물에서 물과 에탄올을 분리하고 싶은 경우,...","categories": [],
        "tags": ["학습","열역학","상태방정식","기액평형"],
        "url": "/blog/2024/01/28/EOS-VLE.html",
        "teaser": null
      },{
        "title": "칼만필터 (Kalman Filter)",
        "excerpt":"칼만필터 개요 칼만필터는 어떠한 값의 다이나믹 거동을 선형적인 식으로 기술할 수 있고, 원하는 값을 측정할 수 있는 상황에서, 하지만 이 다이나믹 식과 측정 값에 불확실성이 있어 각각의 값들이 확률변수로 취급되어야 하는 상황에서 원하는 값을 가장 합리적으로 추정해야 할 때 사용할 수 있는 원하는 값을 추정하는 최적(optimal) 방법이다. 이때 확률변수는 평균과...","categories": [],
        "tags": ["학습","칼만필터"],
        "url": "/blog/2024/01/28/Kalman-Filter.html",
        "teaser": null
      }]

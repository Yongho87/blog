var store = [{
        ...
        "title": "성장을 위한 지식 #6",
        "excerpt":"Business &amp; Startup 12가지 일반적인 가치의 형태 (경제적 가치를 제공할 수 있는) 우리들의 사업이 성공하기 위해서는 사람들에게 가치를 주어야 하고 이것은 사람들이 돈을 지불할 수 있도록 어떠한 형태를 갖고 있어야 한다. 다음은 12가지의 일반적인 가치의 형태와 이것들에 단순화된 개념이다. 제품: 유형의 물건 (물리적일 수도 디지털 형태일 수도 있음)을 만들어서 파는것....","categories": [],
        "tags": [],
        "url": "/blog/2021/03/14/%EC%84%B1%EC%9E%A5%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A7%80%EC%8B%9D-6.html",
        "teaser": null
      },{
        "title": "비트코인과 암호화폐 #1",
        "excerpt":"참고문서: 레이달리오와 브릿지워터의 비트코인에 대한 관점 비트코인의 최근의 상승은 비트코인이 재산과 부의 저장공간으로 사용할 될 수 있을지에 대한 논의를 다시 불붙이고 있다 비트코인은 2020년에만 약 4배가 상승 현재 비트코인은 전체 암호화폐 시장중에 약 80%의 점유율을 가짐. 2017년 초반의 상승기때는 다른 코인들이(리플, 이더리움) 주도적으로 상승을 견인했으나 2020년부터 지금까지의 상승에서는 비트코인이 상승을...","categories": [],
        "tags": [],
        "url": "/blog/2021/03/17/%EB%B9%84%ED%8A%B8%EC%BD%94%EC%9D%B8%EA%B3%BC-%EC%95%94%ED%98%B8%ED%99%94%ED%8F%90-1.html",
        "teaser": null
      }]
